package com.application.real_estate_app.feature_auth.viewModels
...
import com.application.real_estate_app.feature_auth.repositories.UserRepository
...
class AuthViewModel @Inject constructor(
    ...
    val requestCode = Signing.RC_SIGN_IN
    ...
    fun signInWithPhoneAuthCredential(credential: PhoneAuthCredential) {
        viewModelScope.launch {
            try {
                ...
                _phoneVerificationState.value = VerificationState.Error(e.message ?: "Unknown error")
            }
        }
    }
    ...
    suspend fun resetPassword(email: String){
        try {
            ...
            _resetPasswordStatus.emit(Result.failure<Boolean>(e))
        }
    }
    ...
    fun registerUser(
        ...
        viewModelScope.launch {
            try {
                ...
                _phoneVerificationState.value = VerificationState.Error("Sign-up failed: ${e.message}")
            }
        }
    }
    ...
    sealed class VerificationState {
        object Idle : VerificationState() // Default state
    ...
    data class LoginEvent(val message: String = "User logged in")
}
