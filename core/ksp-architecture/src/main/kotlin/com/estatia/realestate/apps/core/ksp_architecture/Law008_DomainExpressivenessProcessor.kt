 ...
 */
class Law008_DomainExpressivenessProcessor(
...
class Law008_DomainExpressivenessProcessorProvider : SymbolProcessorProvider {
    override fun create(environment: SymbolProcessorEnvironment): SymbolProcessor {
        return Law008_DomainExpressivenessProcessor(environment.logger)
    }
}
