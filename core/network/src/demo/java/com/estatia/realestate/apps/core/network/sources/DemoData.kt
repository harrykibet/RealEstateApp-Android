...
object DemoData {
    val sampleProperties = listOf(
        ...
        PropertyEntityModel(
            ...
            videoUrl = listOf("https://storage.googleapis.com/exoplayer-test-media-1/mp4/frame-counter-one-hour.mp4"),
            video = true,
            ownerName = "Harry Kemboi",
            ownerId = "demo_user"
        ),
        PropertyEntityModel(
            ...
            videoUrl = listOf("https://storage.googleapis.com/exoplayer-test-media-0/BigBuckBunny_320x180.mp4"),
            video = true,
            ownerName = "James Kibet",
            ownerId = "user_123"
        )
