...
class GoogleCloudKmsManager @Inject constructor(
    ...
    override suspend fun decryptDataSymmetric(ciphertextBase64: String): String {
        ...
        return try {
            ...
            logger.d(
                "Completed symmetric decryption" +
                        mapOf("keyId" to remoteConfig.getSymmetricKeyId(), "dataLength" to plaintext.length)
            )
    ...
    override suspend fun encryptDataAsymmetric(plaintext: String): String {
        ...
        return try {
            ...
            logger.d(
                "Completed asymmetric encryption" +
    ...
    override suspend fun decryptDataAsymmetric(ciphertextBase64: String): String {
        ...
        return try {
            ...
            logger.d(
                "Starting asymmetric decryption" +
                        mapOf("keyVersion" to keyVersionName)
            )
            ...
            logger.d(
                "Completed asymmetric decryption" +
                        mapOf("keyVersion" to keyVersionName)
            )
    ...
    private fun getLatestAsymmetricKeyVersion(): CryptoKeyVersionName {
        val keyName = getAsymmetricKeyName()

        return kmsClient.listCryptoKeyVersions(keyName)
            .iterateAll()
    ...
    private fun getSymmetricKeyName(): CryptoKeyName {
    ...
    private fun getAsymmetricKeyName(): CryptoKeyName {
        return CryptoKeyName.of(
            projectId,
            remoteConfig.getKeyRingLocationId(),
            remoteConfig.getKeyRingId(),
