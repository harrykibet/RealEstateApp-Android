...
class AddPropertyViewModel @Inject constructor(
    ...
    fun saveProperty(onFailure: (Exception) -> Unit) {
        ...
        val property = Property(
            ...
            imageUrls = emptyList(), // AUTOGENERATED by FireBaseStorage
            videoUrls = emptyList(), // AUTOGENERATED by FireBaseStorage
            ownerId = userId,
            ...
            likesCount = null,   //RESERVED, Not implemented yet
            commentsCount = null, //RESERVED, Not implemented yet
            sharesCount = null,  //RESERVED, Not implemented yet
            id = null,          //AUTOGENERATED by FireBaseFireStore
            videosAvailable = state.selectedVideoUris.isNotEmpty()
        )
